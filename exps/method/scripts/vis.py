...
def gt_vis(part_pcs, part_poses, part_valids, num_ins, args):
    ...
    for cur_idx in range(batch_size):
        ...
        render_utils.render_part_pts(
            os.path.join(part_dir, data_name),
            input_part_pcs,
...
def gt_vis_wip(part_pcs, part_poses, part_valids, part_cates, num_ins, args):
    ...
    for cur_idx in range(batch_size):
        ...
        for pair_id, pair in enumerate(pairs):
            ...
            render_utils.render_part_pts(assembly_file, cur_gt_part_pcs, blender_fn="object_centered.blend")
