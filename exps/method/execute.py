...
parser.add_argument(
    ...
    type=str,
    choices=["step", "cosine"],
    help="The type of learning rate update.",
)
parser.add_argument(
    "-b",
    "--batch-size",
...
parser.add_argument(
    ...
    type=int,
    metavar="N",
    help="epoch start for evaluation.",
)
...
# * Network settings.
parser.add_argument("--model", default="trans_assembly_v1", type=str, help="model name.")
parser.add_argument("--model_version", default="original", type=str, help="model version.")
parser.add_argument(
    "--backbone",
    default="pointnet_cls",
    type=str,
    help="the backbone to extract init features.",
)
...
parser.add_argument(
    ...
    default=1,
    type=int,
    help="Whether to cat pose in trans-encoder.",
)
parser.add_argument(
    "--shared-pred",
    default=1,
    type=int,
    help="Whether to apply shared mlp & predictor.",
)
...
parser.add_argument(
    "--noise-cat-in-encoder",
    default=1,
    type=int,
    help="Whether to cat noise when in trans-encoder.",
)
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="Whether to cat ins part id when in trans-encoder.",
)
parser.add_argument(
    "--ins-cat-inter-only",
    default=0,
    type=int,
    help="Whether to only cat ins inter pos when in trans-encoder.",
)
parser.add_argument(
    "--ins-cat-intra-only",
    default=0,
    type=int,
    help="Whether to only cat ins intra pos when in trans-encoder.",
)
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="Whether to apply worst mon during encoder inference.",
)
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="Whether to apply random positive number (1 - num-pos)",
)
parser.add_argument(
    "--pose-cat-in-decoder-pred",
    default=1,
    type=int,
    help="Whether to cat pose when in decoder-pred.",
)
parser.add_argument(
    "--pose-cat-in-decoder-trans",
    default=1,
    type=int,
    help="Whether to cat pose when in decoder-trans.",
)
parser.add_argument(
    "--noise-cat-in-decoder-pred",
    default=1,
    type=int,
    help="Whether to cat noise when in decoder-pred.",
)
parser.add_argument(
    "--noise-cat-in-decoder-trans",
    default=1,
    type=int,
    help="Whether to cat noise when in decoder-trans.",
)
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="Whether to freeze backbone/encoder during training.",
)
parser.add_argument(
    "--ins-cat-in-decoder",
    default=1,
    type=int,
    help="Whether to cat ins part id in trans-decoder.",
)
...
parser.add_argument(
    ...
    default=0,
    type=int,
    help="Whether to apply encoder pred visualization.",
)
parser.add_argument(
    "--pred-encoder-vis-dir",
    default="./checkpoints/encoder_pred/",
    type=str,
    help="relative path to root dir.",
)
...
def main():
    ...
    test_dataset = PartNetPartDataset(
        args.data_dir,
        args.test_data_fn,
        args.category,
        level=args.level,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        print("==========================================================")
        print(f"Best Part Accuracy: {best_acc}")
        print("==========================================================")
        res_best = (
            "\n=========================================================="
            + "\n"
            + f"Best Part Accuracy: {best_acc}"
            + "\n"
            + "==========================================================\n"
        )
